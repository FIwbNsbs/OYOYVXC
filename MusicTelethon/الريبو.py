...
async def restart(client, m: Message):
    ...
    await loli.edit("8")
    await loli.edit("9")
    await loli.edit("** تم اعاده تشغيل موسيقى توباك ✅**")
